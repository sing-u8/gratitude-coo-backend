...
import { BadRequestException, ForbiddenException, Inject, Injectable, LoggerService, NestMiddleware, UnauthorizedException } from "@nestjs/common";
...
export class BearerTokenMiddleware implements NestMiddleware {
    ...
    async use(req: Request, _: Response, next: NextFunction) {
        ...
        this.logger.log(`bearer token middleware --- decodedPayload: ${JSON.stringify(decodedPayload)}`);
        ...
        try {
            ...
            req.user = payload;
            this.logger.log(`bearer token middleware --- req.user: ${JSON.stringify(req.user)}`);
            next();
        } catch (e) {
